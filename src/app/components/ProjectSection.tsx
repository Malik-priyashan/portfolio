...
export default function ProjectSection() {
  ...
  useEffect(() => {
    fetch("/api/sheet")
      .then((res) => res.json())
      .then((json) => {
        console.log("Fetched project data from backend:", json);
  ...
  if (loading) {
    // Show carousel skeleton with navigation arrow skeletons outside the card container
    return (
            ...
            >
              ...
              >
                ...
                >
                  {/* Image at top */}
                  {row.image && (
                    <div className="w-full h-48 sm:h-64 rounded-xl overflow-hidden mb-4 shadow-lg">
                      <img
                        src={row.image}
